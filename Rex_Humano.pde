...
//metodos
 Rex(){
  ...
  this.chaleco2=color(46,46,46);
  this.chaleco3=color(31,31,31);
  this.traje=color(167,141,32);
  this.gris=color(74,74,74);
  this.verde=color(3,245,11);
  this.a=4;
  this.a1=6;
 }
void display(){
 ...
 //Inicio Arma
  ...
  rect(127,177,this.a,this.a);
  rect(131,177,this.a,this.a);
  rect(135,177,this.a,this.a);
  rect(139,177,this.a,this.a);
  rect(119,173,this.a,this.a);
  rect(123,173,this.a,this.a);
  rect(127,173,this.a,this.a);
  rect(131,173,this.a,this.a);
  rect(135,173,this.a,this.a);
  rect(139,173,this.a,this.a);
  rect(143,173,this.a,this.a);
  ...
  fill(this.verde);
   rect(139,169,this.a,this.a);
   rect(127,169,this.a,this.a);
  fill(this.negro);
  for(int x=85; x<=97; x++){
    rect(x,185,this.a,this.a);
  }
